...
<div id="main">
	...
	<div class="container">
		...
		<s:if test="#session.CreateUserDTO != null" >
			...
			<p>名字：<input type="text" name="familyName" value="<s:property value='#session.CreateUserDTO.familyName' />">
			名前：<input type="text" name="firstName" value="<s:property value='#session.CreateUserDTO.firstName' />"></p>

			<p>氏名をひらがなで入力して下さい。</p>
			<p><s:property value='errorMsg.familyNameKana' /></p>
			<p><s:property value='errorMsg.firstNameKana' /></p>
			<p>みょうじ：<input type="text" name="familyNameKana" value="<s:property value='#session.CreateUserDTO.familyNameKana' />">
			なまえ：<input type="text" name="firstNameKana" value="<s:property value='#session.CreateUserDTO.firstNameKana' />"></p>
		...
		<s:else>
			...
			<p><s:property value='errorMsg.familyName' /></p>
			<p><s:property value='errorMsg.firstName' /></p>
			<p>名字：<input type="text" name="familyName" value="<s:property value='familyName' />">
			   名前：<input type="text" name="firstName" value="<s:property value='firstName' />"></p>

			<p>氏名をひらがなで入力して下さい。</p>
			<p><s:property value='errorMsg.familyNameKana' /></p>
			<p><s:property value='errorMsg.firstNameKana' /></p>
			<p>みょうじ：<input type="text" name="familyNameKana" value="<s:property value='familyNameKana' />">
			   なまえ：<input type="text" name="firstNameKana" value="<s:property value='firstNameKana' />"></p>

			<p>性別を選択して下さい。</p>
			<p>
			<s:if test="sex == null || sex == 0">
			<input type="radio" name="sex" value="0" checked>男性
			<input type="radio" name="sex" value="1">女性
			</s:if>
