...
<!--  headerの始まり -->
	...
	<!-- 背景の画像 -->
		...
		<map name="mapping">
			...
			<area class="background-image-area"  data-src="BackgroundImage/homeBackgroundChair2.jpg" shape="poly" coords="1100,901,1098,814,1295,814,1304,902,1279,883,1284,828,1260,824,1238,824,1238,881,1194,887,1184,897,1175,899" href="<s:url action='ProductSearchAction' ></s:url>?category_id=1&&retrievalValue=チェア" alt="リンク5">
			<area class="background-image-area"  data-src="BackgroundImage/homeBackgroundChair3.jpg" shape="poly" coords="1599,814,1599,880,1574,891,1575,897,1566,904,1513,904,1530,887,1531,873,1502,851,1502,844,1502,823,1513,811" href="<s:url action='ProductSearchAction' ></s:url>?category_id=1&&retrievalValue=チェア" alt="リンク6">
			<area class="background-image-area"  data-src="BackgroundImage/homeBackgroundTable2.jpg" shape="poly" coords="623,844,623,901,752,901,766,873,766,867,804,865,820,817,817,789,595,789,540,831,542,838" href="<s:url action='ProductSearchAction' ></s:url>?category_id=4&&retrievalValue=テーブル " alt="リンク7">
